      ...
      <div className="flex h-14 items-center gap-3 px-4">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <Link
            href="/"
            target="_blank"
            className="hidden h-9 items-center gap-1.5 rounded-md border border-line-dark-2 px-3 font-sans text-[11px] font-extrabold uppercase tracking-[0.12em] text-fg-dark-soft transition-colors hover:bg-bg-800 hover:text-fg-dark sm:inline-flex"
          >
            <ExternalLink size={12} strokeWidth={2.5} /> View site
          </Link>
          <button
            type="button"
            onClick={onLogout}
