...
export function OverlayForm({ productId }: { productId: string }) {
  ...
  return (
    <form action={action} className="space-y-3">
      ...
      <Field label="Gift name (optional)" hint="ถ้าเว้นว่าง จะใช้ชื่อไฟล์เป็นชื่อ — แก้ทีหลังได้">
        <input
          ref={nameRef}
          name="name"
          type="text"
          maxLength={80}
          placeholder="Judy Legend Overlay"
